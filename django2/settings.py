...
SECRET_KEY = 'jt(843+yp3kobxb^d)7r-3)mh^og3+5l@_ct=_pjzfz!$bki+v'
...
"""
# Se for publicar em um local com servidor de emial: Comentar o BACKEND e retirar as aspas da configuração acima.
